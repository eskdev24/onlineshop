        ...
        <form class="mt-8 space-y-6" action="{{ route('login.submit') }}" method="POST">
            ...
            <div class="space-y-4">
                ...
                <div x-data="{ show: false }" class="relative">
                    ...
                    <input id="password" name="password" :type="show ? 'text' : 'password'" required class="appearance-none relative block w-full px-4 py-3 border border-gray-300 placeholder-gray-500 text-gray-900 rounded-xl focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm" placeholder="Password">
